...
if __name__ == '__main__':
    ...
    k = [0] * 81
    k[18] = 1
    save_image(correlate(pigbird, k), "test_images/pigbirdkernel.png")

    cat = load_image("test_images/cat.png")
    save_image(blurred(cat, 5), "test_images/blurredcat.png")

    python = load_image("test_images/python.png")
    save_image(sharpened(python, 11), "test_images/sharppython.png")
